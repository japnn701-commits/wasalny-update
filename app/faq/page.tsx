...
export default function FAQPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "نعم، نستخدم بوابات دفع آمنة ومشفرة. يمكنك الدفع بالفيزا، الماستركارد، أو المحافظ الإلكترونية. كما نوفر خيار الدفع عند الاستلام.",
    },
    {
    ...
    },
    {
      ...
      answer: "نعم، يمكنك استخدام نظام الشات الداخلي للتواصل مع العامل، طرح الأسئلة، وإرسال صور إضافية للمشكلة.",
    },
    {
